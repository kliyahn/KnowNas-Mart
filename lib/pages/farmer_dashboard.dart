...
// FIXED VERSION - Displays actual user data from Supabase
...
import '/pages/mypurchase_farmer.dart';
import '/pages/your_product.dart';
...
class _FarmerDashboardPageState extends State<FarmerDashboardPage> {
  ...
  Future<void> _loadUserProfile() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _fullName = response['full_name'] ?? 'Farmer';
          _farmLocation = response['farm_location'] ?? 'No location set';
          _isLoadingProfile = false;
        });
      }
    } catch (e) {
      if (mounted) {
        setState(() {
          ...
          _farmLocation = 'Error loading location';
          _isLoadingProfile = false;
        });
      }
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              _fullName, // DYNAMIC - Shows actual user's name
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  _farmLocation, // DYNAMIC - Shows actual farm location
                                  style: const TextStyle(
                                    color: Colors.white70,
                                    fontSize: 12,
                                  ),
                        ...
                        _buildQuickActionButton(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const AnalyticsFarmerPage(cartItems: [],),
                              ),
                            );
                          },
                        ),
                        ...
                        _buildQuickActionButton(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => YourProductsPage(
                                  cartItems: _buildCartItems(),
                                ),
                              ),
                            );
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const YourProductsPage(cartItems: [],),
                          ),
                        );
                      },
