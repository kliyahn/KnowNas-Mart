...
import '/pages/login_farmer.dart'; // Import login farmer page

class CreateFarmerAccountPage extends StatefulWidget {
  const CreateFarmerAccountPage({super.key});

  @override
  State<CreateFarmerAccountPage> createState() => _CreateFarmerAccountPageState();
}
        ...
        actions: [
          TextButton(
            onPressed: () {
              ...
              _farmLocationController.text = 'Lot 1752 & 1753, Kampung Bukit Senggeh, Mukim Bukit Senggeh, 77200 Jasin, Melaka';
            },
            child: const Text('OK'),
          ),
        ],
  ...
  void _handleCreateAccount() async {
    ...
    try {
      await _supabaseService.signUp(
        ...
        location: _farmLocationController.text, // Saved to farm_location column
        role: role,
      );
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const LoginFarmerPage(),
                            ),
                          );
                        },
                        child: RichText(
