...
import 'package:sulam/widgets/bottom_nav_buyer.dart';

class AnalyticsBuyerPage extends StatefulWidget {
  const AnalyticsBuyerPage({super.key});

  @override
  State<AnalyticsBuyerPage> createState() => _AnalyticsBuyerPageState();
}

class _AnalyticsBuyerPageState extends State<AnalyticsBuyerPage> {
