...
class ProductsBuyerPage extends StatefulWidget {
  const ProductsBuyerPage({super.key});

  @override
  State<ProductsBuyerPage> createState() => _ProductsPageState();
}

class _ProductsPageState extends State<ProductsBuyerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: const BottomNavBarBuyer(currentIndex: 1),
    );
  }
